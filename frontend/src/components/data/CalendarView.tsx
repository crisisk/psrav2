...
const DragAndDropCalendar = withDragAndDrop(Calendar as React.ComponentType<any>) as React.ComponentType<WithDragAndDropProps<CalendarEvent, object>>;
...
const CalendarView: React.FC = () => {
  ...
  const onEventDrop: WithDragAndDropProps<CalendarEvent, object>['onEventDrop'] = useCallback(
  ...
  const onEventResize: WithDragAndDropProps<CalendarEvent, object>['onEventResize'] = useCallback(
    ({ event, start, end }) => {
      const updatedEvents = events.map(existingEvent =>
        existingEvent.id === event.id
